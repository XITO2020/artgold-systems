export const COLOR_FILTERS: Record<string, { name: string; value: string; class: string }> = {
  chilired: { name: "Chili Red", value: "#D12F26", class: "bg-[#D12F26]" },
  cactusgreen: { name: "Cactus Green", value: "#3D6A44", class: "bg-[#3D6A44]" },
  violeteve: { name: "Violet Eve", value: "#6A4C9C", class: "bg-[#6A4C9C]" },
  orangedesert: { name: "Orange Desert", value: "#E07A5F", class: "bg-[#E07A5F]" },
  yellowsand: { name: "Yellow Sand", value: "#F4A300", class: "bg-[#F4A300]" },
  warmblue: { name: "Warm Blue", value: "#1D7F97", class: "bg-[#1D7F97]" },
  sandsmog: { name: "Sand Smog", value: "#D0C1A1", class: "bg-[#D0C1A1]" },
  rockybrown: { name: "Rocky Brown", value: "#8B6B4A", class: "bg-[#8B6B4A]" },
  amberdust: { name: "Amber Dust", value: "#C88A43", class: "bg-[#C88A43]" },
  jalapenogreen: { name: "Jalapeno Green", value: "#5A7F3E", class: "bg-[#5A7F3E]" },
  lagoonturquoise: { name: "Lagoon Turquoise", value: "#3C8C8D", class: "bg-[#3C8C8D]" },
  yellowhotsun: { name: "Yellow Hot Sun", value: "#FFCD02", class: "bg-[#FFCD02]" },
  watermelonpink: { name: "Watermelon Pink", value: "#F24C7F", class: "bg-[#F24C7F]" },
};
