  ...
  return (
    <section className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        <h2 className="text-5xl font-bold text-center mb-12 text-muted-foreground font-aguaextra" >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="p-6 mb-2">
            ...
            <h3 className="text-xl font-semibold mb-2 tracking-widest">{dict.home.features.validation.title}</h3>
            <p className="text-muted-foreground">
              {dict.home.features.validation.description}
            </p><p className="text-yellow-200 font-bold">  
          ...
          <Card className="p-6 mb-2">
            ...
            <h3 className="text-xl font-semibold mb-2 tracking-widest">{dict.home.features.growth.title}</h3>
            <p className="text-muted-foreground">
          ...
          <Card className="p-6">
            ...
            <h3 className="text-xl font-semibold mb-2 tracking-widest">{dict.home.features.distribution.title}</h3>
            <p className="text-muted-foreground">
          ...
          <Card className="p-6">
            ...
            <div className="font-semibold flex flex-col justify-between h-[60%] mt-4 mx-auto">
              <p className="">{dict.home.features.details.exp1}</p>
              <p className="text-green-300 font-bold">{dict.home.features.details.exp2}</p>
              <p className="">{dict.home.features.details.exp3}</p>
              <p className="text-yellow-200 font-bold">{dict.home.features.details.exp4}</p>
            </div>
          </Card>
          <Card className="p-6">
            ...
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              ...
              <p className="font-bold text-yellow-200">{dict.home.features.financing.exp3}</p>
              <p className="font-semibold text-green-300">{dict.home.features.financing.exp4}</p>
            </div>
          </Card>
          <Card className="p-6">
            <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              ...
              <p className="mb-2 text-amber-500 font-bold text-center">{dict.home.features.industries.exp2}</p>
              <p className="mb-2 text-amber-400 font-bold text-center">{dict.home.features.industries.exp3}</p>
              <p className="mb-2 text-amber-300 font-bold text-center">{dict.home.features.industries.exp4}</p>
            </div>
          </Card>
        </div>
      </div>
      <h2 className="text-center w-full mt-2 text-3xl font-aguatitle text-sky-100">{dict.home.nogen}</h2>
    </section>
  );
};
