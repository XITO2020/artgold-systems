...
const Features: React.FC<FeaturesProps> = ({ dict, lang }) => {
  ...
  return (
    <section className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="p-6 mb-2">
            <div className="mb-4">
            <div className="p-3 rounded-full bg-black  border-opacity-10 border-2 border-teal-400">
          ...
          <Card className="p-6">
            ...
            <div className="p-3 rounded-full bg-black  border-opacity-10 border-2 border-teal-400">
              <Banknote className="h-12 w-12 text-teal-400" />
              </div>
          ...
          <Card className="p-6">
            ...
            <div className="p-3 rounded-full bg-black  border-opacity-10 border-2 border-teal-400">
              <Store className="h-12 w-12 mb-2 text-teal-400" />
              </div>
              <h3 className="text-xl font-semibold mb-2">
          ...
          <Card className="p-6">
            <div className="flex flex-col items-center justify-center">
            <div className="p-3 rounded-full bg-black  border-opacity-10 border-2 border-teal-400">
              <Factory className="h-12 w-12 mb-2 text-teal-400" />
              </div>
              <h3 className="text-xl font-semibold mb-2">
      ...
      <h2 className="text-center w-full mt-2 text-3xl font-matrixtitle text-teal-400">{dict.home.nogen}</h2>
    </section>
  );
};
