...
export function ValueDistribution({ dict, lang }: ValueDistributionProps) {
  ...
  return (
    <div className="space-y-8 bg-gradient-to-r from-emerald-950 via-black to-emerald-900">
      {/* Distribution des valeurs */}
      <Card className="p-6">
        <h3 className="text-xl text-emerald-400 font-semibold mb-4">{dict.home.value.title}</h3>
      ...
      <Card className="p-6">
        <div className="flex">
          <div className="space-y-6">
            <h3 className="text-xl text-emerald-400 font-semibold mb-4">{dict.home.validation.token.title}</h3>
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-full bg-black  border-opacity-10 border-2 border-green-200">
                <Coins className="h-6 w-6 text-green-300" />
              </div>
              <div>
                <h4 className="font-semibold mb-2">TABZ Token (Gold-Backed)</h4>
                <p className="text-teal-400">{dict.home.validation.token["p-intro"]}</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-teal-400">{dict.home.validation.token["p-intro2"]}</p>
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-full bg-black  border-opacity-10 border-2 border-teal-200">
                <Lock className="h-6 w-6 text-teal-400" />
              </div>
              <div>
                <h4 className="font-semibold mb-2">1 to 3 -Years Lockup Period</h4>
                <p className="text-teal-400">{dict.home.validation.token["p-intro3"]}</p>
                <ul className="space-y-2 text-sm text-muted-foreground">
      ...
      {/* Timeline */}
      <Card className="p-6">
        <h3 className="text-xl font-semibold mb-4 text-emerald-400">{dict.home.validation.market.entry}</h3>
