...
export function ValidationProcess({ dict, lang }: ValueDistributionProps) {
  return (
    <div className="grid md:grid-cols-2 gap-8 my-5 bg-gradient-to-r from-black via-emerald-950 to-black">
      <Card className="p-6">
        <div className="flex items-start gap-4">
          <div className="p-3 rounded-full bg-black  border-opacity-10 border-2 border-teal-400">
            <Shield className="h-6 w-6 text-emerald-600 dark:text-sky-200" />
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2 text-emerald-400">{dict.home.ai.title}</h3>
            <p className="text-muted-foreground">
            {dict.home.ai.parag}
            </p>
            <ul className="mt-2 space-y-2">
              <li className="flex items-center gap-2">
                <Ban className="h-4 w-4 text-slate-200" />
      ...
      <Card className="p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-emerald-400 text-lg font-semibold mb-2">{dict.home.human.title}</h3>
            <p className="text-muted-foreground">
      ...
      <Card className="p-6 md:col-span-2 bg-red-50 dark:bg-red-900/10">
        <div className="flex items-start gap-4">
          <div className="p-3 rounded-full bg-black  border-opacity-10 border-2 border-teal-400">
            <Scale className="h-6 w-6 text-teal-400 dark:text-teal-400" />
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2 text-emerald-400 dark:text-red-400">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <Ban className="h-4 w-4 mt-1 text-slate-200" />
            ...
            <p className="mt-4 text-sm font-medium text-teal-400 dark:text-teal-400">
