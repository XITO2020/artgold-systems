    ...
    <section className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 mb-2 rounded-lg bg-red-100 hover:bg-red-200 border border-transparent hover:border-red-300 transition-all duration-300 ease-in-out shadow-sm hover:shadow-lg">
            <div className="mb-4">
          ...
          <div className="p-6 mb-2 rounded-lg bg-green-100 hover:bg-green-200 border border-transparent hover:border-green-300 transition-all duration-300 ease-in-out shadow-sm hover:shadow-lg">
            <div className="mb-4">
          ...
          <div className="p-6 mb-2 rounded-lg bg-lime-100 hover:bg-lime-200 border border-transparent hover:border-lime-300 transition-all duration-300 ease-in-out shadow-sm hover:shadow-lg">
            <div className="mb-4">
          ...
          <div className="p-6 mb-2 rounded-lg bg-emerald-50 hover:bg-emerald-100 border border-transparent hover:border-emerald-300 transition-all duration-300 ease-in-out shadow-sm hover:shadow-lg">
            ...
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              <p className="">{dict.home.features.details.exp1}</p>
              <p className="">{dict.home.features.details.exp2}</p>
              <p className="">{dict.home.features.details.exp3}</p>
              <p className="">{dict.home.features.details.exp4}</p>
            </div>
          </div>
          <div className="p-6 mb-2 rounded-lg bg-orange-50 hover:bg-orange-200 border border-transparent hover:border-orange-200 transition-all duration-300 ease-in-out shadow-sm hover:shadow-lg">
            ...
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              ...
              <p className="">{dict.home.features.financing.exp2}</p>
              <p className="">{dict.home.features.financing.exp3}</p>
              <p className="">{dict.home.features.financing.exp4}</p>
            </div>
          </div>
          <div className="p-6 mb-2 rounded-lg bg-yellow-100 hover:bg-yellow-200 border border-transparent hover:border-yellow-300 transition-all duration-300 ease-in-out shadow-sm hover:shadow-lg">
            <div className="flex flex-col items-center justify-center">
