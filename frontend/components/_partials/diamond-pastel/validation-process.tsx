...
export function ValidationProcess({ dict, lang }: ValueDistributionProps) {
  return (
    <div className="grid md:grid-cols-2 gap-8 my-5">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              <li className="flex items-center gap-2">
                <Ban className="h-4 w-4 text-fuchsia-500" />
      ...
      <Card className="p-6">
        <div className="flex items-start gap-4">
          <div className="p-3 rounded-full bg-accentFour">
      ...
      <Card className="p-6 md:col-span-2 bg-red-50 dark:bg-red-900/10">
        <div className="flex items-start gap-4">
          <div className="p-3 rounded-full bg-violet-400">
            <Scale className="h-6 w-6 text-red-800" />
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2 text-violet-400">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <Ban className="h-4 w-4 mt-1 text-violet-400" />
