  ...
  return (
    <section className="relative py-20 px-4">
      <div className="container mx-auto text-center">
        ...
        <p className="text-xl font-bold text-muted-foreground mb-8 max-w-2xl mx-auto">
          {dict.home.hero.description}
        </p>
        <div className="flex justify-center gap-4">
          <Link href={`/${lang}/upload`}>
            <Button size="lg" className="text-2xl hover:bg-yellow-100">
              {dict.home.cta.convert}
            </Button>
          </Link>
          <Link href={`/${lang}/explore`}>
            <Button size="lg" variant="outline" className="text-2xl text-purple-800 hover:bg-purple-500 hover:text-yellow-100">
              {dict.home.cta.explore}
            </Button>
          </Link>
        </div>
        <p className="text-xl font-bold text-muted-foreground mt-8 max-w-2xl mx-auto">
