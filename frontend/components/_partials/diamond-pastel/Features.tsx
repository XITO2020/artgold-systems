...
const Features: React.FC<FeaturesProps> = ({ dict, lang }) => {
  ...
  const themeVars = {
    ...
    'dark': {
      ...
      '--card': 'linear-gradient(rgba(250,22,38,0.3), transparent, rgba(120,120,120;0.3))',
      '--card-foreground': 'hsl(210, 40%, 98%)',
      '--popover': 'hsl(222.2, 84%, 4.9%)',
      '--popover-foreground': 'hsl(210, 40%, 98%)',
  ...
  return (
    <section className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-muted-foreground" >
          {dict.home.features.title}
        </h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 mb-2 rounded-lg bg-yellow-50 hover:bg-yellow-100">
            <div className="mb-4">
              <Shield className="h-12 w-12 text-yellow-500" />
            </div>
            <h3 className="text-xl font-semibold mb-2 text-yellow-500">{dict.home.features.validation.title}</h3>
          ...
          <div className="p-6 mb-2 rounded-lg bg-teal-50 hover:bg-teal-100">
            <div className="mb-4">
              <TrendingUp className="h-12 w-12 text-teal-200" />
            </div>
            <h3 className="text-xl font-semibold mb-2 text-teal-400">{dict.home.features.growth.title}</h3>
            <p className="text-muted-foreground font-bold">
          ...
          <div className="p-6 mb-2 rounded-lg bg-purple-50 hover:bg-purple-100">
            <div className="mb-4">
              <Users className="h-12 w-12 text-fuchsia-200" />
            </div>
            <h3 className="text-xl font-semibold mb-2 text-fuchsia-300">{dict.home.features.distribution.title}</h3>
            <p className="text-muted-foreground font-bold">
          ...
          <div className="p-6 mb-2 rounded-lg bg-green-50 hover:bg-green-100">
            <div className="flex flex-col items-center justify-center text-center">
              <Banknote className="h-12 w-12 text-lime-300" />
              <h3 className="text-xl font-semibold mb-2 text-green-400">
                {dict.home.features.details.title}
              </h3>
            </div>
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              <p className=" text-muted-foreground font-bold">{dict.home.features.details.exp1}</p>
              <p className=" text-muted-foreground font-bold">{dict.home.features.details.exp2}</p>
              <p className=" text-violet-900 font-bold">{dict.home.features.details.exp3}</p>
              <p className=" text-muted-foreground font-bold">{dict.home.features.details.exp4}</p>
            </div>
          </div>
          <div className="p-6 mb-2 rounded-lg bg-pink-50 hover:bg-pink-100">
            <div className="flex flex-col items-center justify-center">
              <Store className="h-12 w-12 mb-2 text-pink-200" />
              <h3 className="text-xl font-semibold mb-2 text-pink-300">
                {dict.home.features.financing.title}
              </h3>
            </div>
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto text-violet-900">
              <p className=" font-bold text-muted-foreground">{dict.home.features.financing.exp1}</p>
              ...
              <p className="text-violet-900 font-bold">{dict.home.features.financing.exp2}</p>
              <p className="text-violet-900 font-bold">{dict.home.features.financing.exp3}</p>
              <p className="text-violet-900 font-bold">{dict.home.features.financing.exp4}</p>
            </div>
          </div>
          <div className="p-6 mb-2 rounded-lg bg-amber-50 hover:bg-amber-100">
            <div className="flex flex-col items-center justify-center">
              <Factory className="h-12 w-12 mb-2 text-amber-300" />
              <h3 className="text-xl font-semibold mb-2 text-amber-500">
                {dict.home.features.industries.title}
              </h3>
            </div>
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto text-violet-900">
              <p className="text-muted-foreground font-bold mb-2">{dict.home.features.industries.exp1}</p>
              <div className="flex justify-evenly mb-3">
                <Link href={`/${lang}/shop`}>
              ...
              <p className="mb-2 text-violet-900 font-bold">{dict.home.features.industries.exp2}</p>
              <p className="mb-2 text-violet-900 font-bold">{dict.home.features.industries.exp3}</p>
              <p className="mb-2 text-violet-900 font-bold">{dict.home.features.industries.exp4}</p>
            </div>
          </div>
        </div>
      </div>
