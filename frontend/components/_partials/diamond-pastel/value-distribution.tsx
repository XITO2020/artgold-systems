...
export function ValueDistribution({ dict, lang }: ValueDistributionProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Système de tokens */}
      <div className="p-12 bg-gradient-to-b from-white to-transparent">
        <div className="flex">
          <div className="space-y-6">
            <h3 className="text-xl font-semibold mb-4 text-violet-600">{dict.home.validation.token.title}</h3>
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-full bg-yellow-100">
                <Coins className="h-6 w-6 text-yellow-600" />
              </div>
              <div>
                <h4 className="font-semibold mb-2 text-violet-950">TABZ Token (Gold-Backed)</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold mb-2 text-violet-950">AGT Token (Silver-Backed)</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold mb-2 text-violet-950">1 to 3 -Years Lockup Period</h4>
          ...
          <div className="flex flex-col items-center justify-between w-[40%] mx-auto text-center">
            <h2 className="font-semibold mb-2 text-violet-950">{dict.home.introducing.catchphrase1}</h2>
            <div ref={gifRef}>
              {gifVisible ? (
                <img
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="relative pt-1">
            ...
            <Progress value={50} className="h-2 bg-violet-300" />
          </div>

          <div className="relative pt-1">
            <div className="flex mb-2 items-center justify-between">
              <div>
                <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full bg-yellow-100">
