  ...
  return (
    <section className="relative py-20 px-4">
      <div className="container mx-auto text-center">
        <h1 className={`text-5xl font-aguaextra mb-6 ${gradientClass} bg-clip-text text-transparent`}>
        ...
        <div className="flex justify-center gap-4">
          <Link href={`/${lang}/upload`}>
            <Button size="lg" className="text-lg text-cyan-600 hover:bg-blue-900 hover:text-white">
              {dict.home.cta.convert}
            </Button>
          </Link>
          <Link href={`/${lang}/explore`}>
            <Button size="lg" variant="outline" className="text-lg text-teal-400 hover:text-white">
              {dict.home.cta.explore}
            </Button>
          </Link>
        </div>
        <p className="text-xl text-blue-600 mt-8 max-w-2xl mx-auto">
