  ...
  return (
    <section className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12 text-red-700 font-silverextra" >
          {dict.home.features.title}
        </h2>
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="p-6 mb-2 bg-muted/50">
            <div className="mb-4">
              <Shield className="h-12 w-12 text-red-700" />
            </div>
          ...
          <Card className="p-6">
            <div className="flex flex-col items-center justify-center text-center">
              <Banknote className="h-12 w-12 text-yellow-100" />
              <h3 className="text-xl font-semibold mb-2">
                {dict.home.features.details.title}
              </h3>
            </div>
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              <p className="text-center font-bold text-muted-foreground">{dict.home.features.details.exp1}</p>
              <p className="text-center font-bold text-muted-foreground">{dict.home.features.details.exp2}</p>
              <p className="text-center font-bold text-muted-foreground">{dict.home.features.details.exp3}</p>
              <p className="text-center font-bold text-muted-foreground">{dict.home.features.details.exp4}</p>
            </div>
          </Card>
          <Card className="p-6">
            <div className="flex flex-col items-center justify-center">
              <Store className="h-12 w-12 mb-2 text-red-600" />
              <h3 className="text-xl font-bold text-muted-foreground mb-2">
                {dict.home.features.financing.title}
              </h3>
            </div>
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto  font-bold text-muted-foreground">
              <p className="">{dict.home.features.financing.exp1}</p>
              <div className="flex justify-evenly mb-3">
                <Link href={`/${lang}/shop`}>
                  <img src="/icons/tbcity.png" height="30" width="130px" alt="tabascocity" />
                  <p>Opérer depuis ce site</p>
                </Link>
                <Link href="www.tshirts.land">
                  <img src="/icons/tshirtsland.png" height="30" width="100px" alt="tabascocity" />
                  <p>Visiter Tshirts.land</p>
                </Link>
              </div>
              <p className=" font-bold text-muted-foreground text-center">{dict.home.features.financing.exp2}</p>
              <p className=" font-bold text-muted-foreground text-center">{dict.home.features.financing.exp3}</p>
              <p className=" font-bold text-muted-foreground text-center">{dict.home.features.financing.exp4}</p>
            </div>
          </Card>
          <Card className="p-6">
            <div className="flex flex-col items-center justify-center">
              <Factory className="h-12 w-12 mb-2 text-fuchsia-700" />
              <h3 className="text-xl font-semibold mb-2">
                {dict.home.features.industries.title}
              </h3>
            </div>
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              <p className="text-muted-foreground text-center font-extrabold mb-2">{dict.home.features.industries.exp1}</p>
              <div className="flex justify-evenly mb-3">
                <Link href={`/${lang}/shop`}>
              ...
              <p className="mb-2 text-red-700 font-bold text-center">{dict.home.features.industries.exp2}</p>
              <p className="mb-2 text-red-800 font-bold text-center">{dict.home.features.industries.exp3}</p>
              <p className="mb-2 text-fuchsia-800 font-bold text-center">{dict.home.features.industries.exp4}</p>
            </div>
          </Card>
        </div>
      </div>
