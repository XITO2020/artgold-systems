...
export function ValueDistribution({ dict, lang }: ValueDistributionProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Système de tokens */}
      <div className="p-6 bg-gradient-to-r from-red-500 via-amber-200 to-yellow-200">
        <div className="flex">
          <div className="space-y-6">
            <h3 className="text-3xl font-semibold mb-4">{dict.home.validation.token.title}</h3>
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-full bg-yellow-100">
                <Coins className="h-6 w-6 text-yellow-600" />
              </div>
              <div>
                <h4 className="font-extrabold text-3xl mb-2 font-silverextra text-red-800">TABZ Token (Gold-Backed)</h4>
            ...
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-full bg-lime-200">
                <TrendingUp className="h-6 w-6 text-lime-600" />
              </div>
              <div>
              <h4 className="font-extrabold text-3xl mb-2 font-silverextra text-red-800">AGT Token (Silver-Backed)</h4>
            ...
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-full bg-pink-200">
                <Lock className="h-6 w-6 text-red-700 font-extrabold" />
              </div>
              <div>
              <h4 className="font-extrabold text-3xl mb-2 font-silverextra text-red-800">One to three -Years Lockup Period</h4>
          ...
          <div className="flex flex-col items-center justify-between w-[40%] mx-auto text-center">
            <h2 className="font-bold mb-2 text-muted-foreground font-silverplus">{dict.home.introducing.catchphrase1}</h2>
            <div ref={gifRef}>
              {gifVisible ? (
                <img
            ...
            <h3 className=" text-muted-foreground font-silverplus font-bold">{dict.home.introducing.catchphrase2}</h3>
