...
const Features: React.FC<FeaturesProps> = ({ dict, lang }) => {
  ...
  return (
    <section className="py-20 bg-muted/30 border-t-stone-400 border-t-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="p-6">
            ...
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              <p className="text-lime-300">{dict.home.features.details.exp1}</p>
              <p className="text-yellow-300">{dict.home.features.details.exp2}</p>
              <p className="text-amber-300">{dict.home.features.details.exp3}</p>
          ...
          <Card className="p-6">
            ...
            <div className="flex flex-col justify-between h-[60%] mt-4 mx-auto">
              ...
              <div className="flex justify-evenly mb-3">
                <a href={`/${lang}/shop`} className="h-[120px] block">
                  <img src="/icons/tbcity.png" width="160" alt="tabascocity" />
                  <p>Opérer depuis ces sites</p>
                </a>
                <a href="https://www.tshirts.land" className="mx-auto h-[120px] text-center block">
                  <img src="/icons/tshirtsland.png" width="100" alt="tshirtland" />
                </a>
              </div>
              <p className="mb-2 text-fuchsia-300 text-center">{dict.home.features.financing.exp2}</p>
              <p className="mb-2 text-purple-400 text-center">{dict.home.features.financing.exp3}</p>
              <p className="text-violet-500 text-center">{dict.home.features.financing.exp4}</p>
            </div>
          </Card>
          <Card className="p-6">
